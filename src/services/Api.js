...
const Api = {
    ...
    // saveCallLogs: json => request('save-call-logs', json),
    // saveVendorList: json => request('save-vendor-lead', json),
    // search: json => request('search', json),
    ...
    boomSignin: json => request('signin', json),
    boomSignup: json => request('signup', json),
    jobApply: json => request('job_apply', json),
    getmyjobs: () => requestGet('my_jobs'),
    getcategory: () => requestGet('get_category'),
    jobCategoryWise: json => request('job_categorywise', json),
    savejob: json => request('save-job', json),
    removejob: json => request('unsave-job', json),
    uploadDocs: json => request('upload-documents', json),
    updateUserProfile: json => request('update-profile', json),
    creditPlan: json => request('credit-plan', json),
    updateDP: json => request('upload-profile-pic', json),
    addSummary: json => request('add_summary', json),
    // getProfile: json => request('get-profile', json),
    forgotPassword: json => request('forgot_password', json),
    createPassword: json => request('create_password', json),
    getsavedjobs: () => requestGet('my_saved_jobs'),
    getNews: () => requestGet('get-news'),
    getMedia: () => requestGet('get-media'),
    getJobs: () => requestGet('jobs'),
    getProfile: () => requestGet('get-profile'),
    getAllPlans: () => requestGet('get-all-plans'),
    getTradeCenterList: () => requestGet('tradecenterlist'),
    getBannerImage: () => requestGet('get_test_image'),
};
const LocalStorage = {
    ...
    setGoogleUserDetail: user_detail => AsyncStorage.setItem('userdata', user_detail),
    getGoogleUserDetail: () => AsyncStorage.getItem('userdata'),
    setLanguage: language => AsyncStorage.setItem('language', language),
    getLanguage: () => AsyncStorage.getItem('language'),
